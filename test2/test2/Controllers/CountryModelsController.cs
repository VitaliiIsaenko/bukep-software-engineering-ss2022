...
namespace test2.Controllers
{
    public class CountryModelsController : Controller
    {
        ...
        public CountryModelsController(CountryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Salary,Area,People,Sea")] CountryModel countryModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Salary,Area,People,Sea")] CountryModel countryModel)
        {
