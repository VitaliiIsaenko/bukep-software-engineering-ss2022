...

{
    ...
    public static void Main()
    {
        ...
        string[][] countriesInfo = CsvReader.Read("Osipova.csv");
        Country[] countries = new Country[countriesInfo.Length];
        for (int i = 0; i < countriesInfo.Length; i++)
        {
            string[] countryInfo = countriesInfo[i];
            countries[i] = new Country(countryInfo[0],long.Parse(countryInfo[1]), long.Parse(countryInfo[2]), countryInfo[3] == "да");
    }
